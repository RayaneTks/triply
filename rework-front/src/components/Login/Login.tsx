...
export function Login() {
  return (
    <div className="min-h-screen bg-dark-bg flex flex-col lg:flex-row overflow-hidden">
      ...
      {/* Background Visual (Mock Map / Cockpit) */}
      ...
      <div className="w-full lg:w-[500px] bg-white flex flex-col p-8 lg:p-16">
        ...
        <div className="flex-1 flex flex-col justify-center">
           ...
           <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div className="space-y-2">
                 <label className="text-xs font-bold text-light-muted uppercase tracking-wider">Email</label>
              ...
              <div className="space-y-2">
                 <div className="flex justify-between items-center">
                    <label className="text-xs font-bold text-light-muted uppercase tracking-wider">Mot de passe</label>
                    <button className="text-[10px] font-bold text-brand uppercase hover:underline">Oublié ?</button>
                 </div>
                 <div className="relative">
           ...
           <button className="w-full py-4 bg-white border border-light-border rounded-xl font-bold flex items-center justify-center gap-3 hover:bg-light-bg transition-colors">
              <Github size={20} />
              GitHub
           </button>
        </div>
        ...
        <footer className="mt-12 text-center text-sm">
           ...
           <Link to="/planifier" className="text-brand font-bold hover:underline">Créer un compte</Link>
        </footer>
      </div>
    </div>
  );
