...
export function SiteFooter() {
  ...
  return (
    <footer className="bg-card border-t border-light-border px-6 py-12 lg:py-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li><Link href="/planifier" className="text-light-muted text-sm hover:text-brand transition-colors">Planifier</Link></li>
            <li><Link href="/tarifs" className="text-light-muted text-sm hover:text-brand transition-colors">Tarifs</Link></li>
            <li><Link href="/a-propos" className="text-light-muted text-sm hover:text-brand transition-colors">À propos</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li><Link href="/legal/cgu" className="text-light-muted text-sm hover:text-brand transition-colors">CGU</Link></li>
            <li><Link href="/legal/confidentialite" className="text-light-muted text-sm hover:text-brand transition-colors">Confidentialité</Link></li>
            <li><Link href="/legal/mentions" className="text-light-muted text-sm hover:text-brand transition-colors">Mentions légales</Link></li>
          </ul>
        </div>
