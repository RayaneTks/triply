...
export function AboutView() {
  const roadmap = [
    { period: "T3 2026", title: "Partage collaboratif", desc: "Invitez vos amis à voter sur les étapes du voyage." },
    { period: "T4 2026", title: "Réservation directe", desc: "Réservez vos vols et hôtels sans quitter l'interface." },
    { period: "2027", title: "Mode hors-ligne", desc: "Accédez à votre itinéraire même en plein milieu des Alpes sans réseau." },
  ];
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="bg-dark-bg text-white py-24 px-6">
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {roadmap.map((item, i) => (
              <div key={i} className="rounded-3xl border border-white/15 bg-white/5 backdrop-blur-md p-8 space-y-4">
      ...
      <section className="px-6 py-24 text-center space-y-8">
        ...
        <Link href="/planifier" className="btn-primary inline-flex items-center gap-2">
