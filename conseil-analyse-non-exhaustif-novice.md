...
Triply vise à centraliser hôtels, vols, activités, etc., pour simplifier l’organisation de voyage. Le dépôt combine une **SPA Vite + React à la racine** (proxifiée vers Laravel), un backend Laravel (`backend/`) et Docker + Makefile à la racine.
