...
const FRONTEND_ENV = path.join(root, "frontend", "triplydev", ".env");
const FRONTEND_TEMPLATE = path.join(root, "frontend", "triplydev", ".env.example");
...
ensure(FRONTEND_ENV, FRONTEND_TEMPLATE);
syncDbKeys();
