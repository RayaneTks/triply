...
class SubscriptionController extends ApiController
{
    public function confirm(Request $request): JsonResponse
    {
        ...
        if ($stripeSecret !== '') {
            ...
            // MVP fallback: if Stripe lookup isn't configured in Laravel, keep
            // activation path available after successful checkout redirect.
            Log::warning('subscription.confirm.stripe_secret_missing_fallback', [
                'user_id' => $user->id,
                'session_id' => $payload['session_id'],
            ]);
        }
