...
<head>
    ...
    <style>
        ...
        * { font-family: DejaVu Sans, sans-serif; }
        ...
        .header { border-bottom: 3px solid #0096C7; padding-bottom: 12px; margin-bottom: 18px; }
        .brand { color: #0096C7; font-size: 13px; font-weight: bold; letter-spacing: 2px; text-transform: uppercase; }
        h1 { font-size: 24px; margin: 6px 0 2px; color: #0f172a; }
        .destination { color: #475569; font-size: 14px; margin: 0; }
        .meta { margin-top: 12px; }
        .meta-pill {
            display: inline-block; background: #e0f4fb; color: #0077a3;
            border: 1px solid #a9ddec; border-radius: 12px;
            padding: 3px 10px; font-size: 11px; margin-right: 6px;
        }
        h2 {
            font-size: 14px; color: #0096C7; margin: 22px 0 8px;
            border-bottom: 1px solid #e2e8f0; padding-bottom: 4px; text-transform: uppercase; letter-spacing: 1px;
        }
        .day { margin-bottom: 14px; }
        .day-head { background: #f1f5f9; border-left: 4px solid #0096C7; padding: 6px 10px; margin-bottom: 6px; }
        ...
        .act-meta { color: #0077a3; font-size: 11px; text-align: right; white-space: nowrap; }
